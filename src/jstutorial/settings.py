"""
Django settings for jstutorial project.
...
SECRET_KEY = 'x2--h4n8aj=!ih+ywdkolc&j-wzy3c)r=+*-p7+6z3^=y-5y@w'
...
WSGI_APPLICATION = 'jstutorial.wsgi.application'
